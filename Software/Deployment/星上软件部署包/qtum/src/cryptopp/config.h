...
#elif defined(__linux__) || defined(__sun__) || defined(__CYGWIN__) || defined(SYLIXOS)
...
#if defined(CRYPTOPP_UNIX_AVAILABLE) || defined(CRYPTOPP_DOXYGEN_PROCESSING) || defined(SYLIXOS)
