...
#warning ggggggggg   ggggggggg   ggggggggg
            ...
            metadata.hdKeypath = "m/88'/1'/" + boost::chrono::to_string(hdChain.nInternalChainCounter) + "'";
...
#warning ggggggggg   ggggggggg   ggggggggg
            ...
            metadata.hdKeypath = "m/88'/0'/" + boost::chrono::to_string(hdChain.nExternalChainCounter) + "'";
