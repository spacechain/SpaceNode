...
#endif
#include "../../../libboost/src/boost/chrono/io/utility/to_string.hpp"
...
#warning ggggggggg   ggggggggg   ggggggggg
#endif
template <class __S, class _T> __S& operator<<(__S& _out, std::shared_ptr<_T> const& _p);
...
#warning ggggggggg   ggggggggg   ggggggggg
#endif	
		return std::string(buffer) + "." + (millisRemainder < 1 ? "000" : millisRemainder < 10 ? "00" : millisRemainder < 100 ? "0" : "") + boost::chrono::to_string(millisRemainder) + "Z";
	return std::string();
}
...
#warning ggggggggg   ggggggggg   ggggggggg
#endif
template <class __S, class _T> __S& operator<<(__S& _out, std::shared_ptr<_T> const& _p) { if (_p) _out << "@" << (*_p); else _out << "nullptr"; return _out; }
